...
$img_path_init 		= '../../covers/originals/';		// folder to upload initial image into
$img_path_temp 		= '../../covers/temp/';			// folder to hold temporary image into
$img_path_crops		= '../../covers/crops/';			// folder to upload cropped images into
...
$cropAspectRatio	= 4.11;										// set aspect ratio for cropper: 1 = square (width/height = aspect ratio)
