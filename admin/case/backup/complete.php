...
if($error) { // output errors
	...
	$full_web= $test;
	mysqli_query($mysql,"INSERT INTO cover VALUES ('', '$full_web', '$title')")or die ($mysql->error);
	echo "<meta http-equiv='refresh' content='0; url=http://www.mlsdesign.dk/techgroup/Privat/cover.php' />";
