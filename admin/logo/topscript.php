...
$img_path_init 		= '../cms_image/logo/originals/';		// folder to upload initial image into
$img_path_temp 		= '../cms_image/logo/temp/';			// folder to hold temporary image into
$img_path_crops		= '../cms_image/logo/crops/';			// folder to upload cropped images into
...
$cropAspectRatio	= 1.1;										// set aspect ratio for cropper: 1 = square (width/height = aspect ratio)
