...
$img_path_init 		= '../cms_image/blog/originals/';		// folder to upload initial image into
$img_path_temp 		= '../cms_image/blog/temp/';			// folder to hold temporary image into
$img_path_crops		= '../cms_image/blog/crops/';			// folder to upload cropped images into
$img_height_main	= 400;										// main image height (use largest size required)
$img_width_main		= 400;										// main image width
...
$cropAspectRatio	= 25/16;										// set aspect ratio for cropper: 1 = square (width/height = aspect ratio)
