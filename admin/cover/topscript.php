...
$img_path_init 		= '../cms_image/covers/originals/';		// folder to upload initial image into
$img_path_temp 		= '../cms_image/covers/temp/';			// folder to hold temporary image into
$img_path_crops		= '../cms_image/covers/crops/';			// folder to upload cropped images into
